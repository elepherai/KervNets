...
def kresnet18(num_classes=1000):
...
def kresnet34(num_classes=1000):
...
def kresnet50(num_classes=1000):
...
def kresnet101(num_classes=1000):
...
def kresnet152(num_classes=1000):
